...
public class placement extends JFrame implements ActionListener {
	...
	placement(){
		...
		/*____________________________Login Frame_________________________*/
		login=new JFrame();
		...
		Image imgs=Toolkit.getDefaultToolkit().getImage("E:\\New folder\\h.png");
		...
		/*____________________________Frame f_________________________*/
		f=new JFrame();
		f.setLayout(null);
		...
		Image imgs1=Toolkit.getDefaultToolkit().getImage("E:\\New folder\\facebook.png");
		...
		Image imgs2=Toolkit.getDefaultToolkit().getImage("E:\\New folder\\instagram.jpg");
		...
		/*___________________________Frame f1_________________________*/
  	    f1=new JFrame();
		f1.setLayout(null);
		...
		Image imgs3=Toolkit.getDefaultToolkit().getImage("E:\\New folder\\g.jpg");
		...
		/*____________________________Frame f2_________________________*/
		f2=new JFrame();
		f2.setLayout(null);
		...
		/*____________________________Frame f3_________________________*/
		f3=new JFrame();
		f3.setLayout(null);
		//f1.setForeground(Color.black);
		//f1.setUndecorated(true);
		...
		/*____________________________Frame f4_________________________*/
		f4=new JFrame();
		f4.setLayout(null);
		...
		/*____________________________Frame f5_________________________*/
		f5=new JFrame();
		f5.setLayout(null);
		...
		b27.setVisible(true);
		f5.add(b27);
		/*____________________________Frame f6_________________________*/
		f6=new JFrame();
		f6.setLayout(null);
		...
		/*____________________________Frame f7_________________________*/
		f7=new JFrame();
		f7.setLayout(null);
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(o==b14){
        	//int k1=operations.search(Integer.parseInt(t9.getText()));
